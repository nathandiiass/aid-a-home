...
ALTER TABLE public.reviews
DROP CONSTRAINT IF EXISTS check_puntualidad_range,
DROP CONSTRAINT IF EXISTS check_calidad_trabajo_range,
DROP CONSTRAINT IF EXISTS check_profesionalismo_range,
DROP CONSTRAINT IF EXISTS check_cumplimiento_servicio_range,
DROP CONSTRAINT IF EXISTS check_relacion_calidad_precio_range;
...
DROP INDEX IF EXISTS idx_reviews_request_user_unique;
CREATE UNIQUE INDEX idx_reviews_request_user_unique 
